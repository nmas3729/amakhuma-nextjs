    ...
    >
      <div className="container mx-auto px-4">
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="mb-4 flex items-center">
                ...
                <h3 className="text-xl font-semibold text-[#3B3C4D]">
                  {feature.title}
                </h3>
              </div>
        ...
        <div className="mx-auto mb-20 grid max-w-7xl gap-8 md:grid-cols-2">
          <div ref={image1Ref} className="relative min-h-[650px] overflow-hidden rounded-[40px] shadow-2xl">
            <Image
        ...
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-2">
          ...
          <div ref={image2Ref} className="relative min-h-[500px] overflow-hidden rounded-[40px] shadow-2xl">
            <Image
